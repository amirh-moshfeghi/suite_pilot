...
urlpatterns = [
    ...
    path('Parent_Group_Selected/', views.json_material_group_parent_data, name='Parent_Group_Selected'),
    ...
    path('Child_Group_Selected/<str:material_group>/<str:identity_group>/<str:child_group>', views.json_child_group_data, name='Child_Group_Selected'),
